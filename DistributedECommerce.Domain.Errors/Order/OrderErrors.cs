...
namespace DistributedECommerce.Orders.Domain.Errors.Order
{
    public class OrderErrors
    {
        ...
        public static CustomError InvalidCancelOrder(string status) => new CustomError(HttpStatusCode.BadRequest, "cannot_cancel_order", $"Cannot cancel order in status {status}");
